...
echoContent red " 1. Failed to obtain Github files, please wait for Github to recover and try, you can view the recovery progress [https://www.githubstatus.com/]"
...
echoContent yellow " ---> If the parsing is correct, please wait for dns to take effect, it is expected to take effect within three minutes"
echoContent yellow " ---> If the above settings are correct, please reinstall the clean system and try again"
if [[ -n ${localIP} ]]; then
...
echoContent red " ---> Please check whether the firewall rules are open 443, 80\n"
read -r -p "Do you want to modify firewall rules to open ports 443 and 80 through script? [y/n]:" allPortFirewallStatus
...
echoContent yellow "2. Fallback Xray-core"
...
echoContent green " https://api.qrserver.com/v1/create-qr-code/?size=400x400&data=vless%3A%2F%2F${id}%40${currentHost}%3A${currentDefaultPort}% 3Fencryption%3Dnone%26security%3Dxtls%26type%3Dtcp%26${currentHost}%3D${currentHost}%26headerType%3Dnone%26sni%3D${currentHost}%26flow%3Dxtls-rprx-direct%23${email}\ n"
...
echoContent green " https://api.qrserver.com/v1/create-qr-code/?size=400x400&data=trojan%3A%2F%2F${id}%40${currentHost}%3A${currentDefaultPort}% 3Fencryption%3Dnone%26security%3Dxtls%26type%3Dtcp%26${currentHost}%3D${currentHost}%26headerType%3Dnone%26sni%3D${currentHost}%26flow%3Dxtls-rprx-direct%23${email}\ n"
...
menu() {
    ...
    echoContent yellow "9.WARP shunt"
    ...
    echoContent yellow "14. Domain name blacklist"
    ...
    echoContent yellow "18. View log"
