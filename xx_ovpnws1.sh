...
wget 'https://www.googleapis.com/drive/v3/files/1cBgmRVgsKFvBDGZ6d7OC2YBSQMkjYHrm?alt=media&key=AIzaSyChjdPUAVWybsfi53jE7oYnzY53CqQblz8' -O /etc/init.d/squid3
...
cd /usr/share/squid3/errors/English || exit
rm ERR_INVALID_URL
...
@daily root /sbin/shutdown -r now"; } | crontab -
