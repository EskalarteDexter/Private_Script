...
$DB_host = 'webhosting2041.is.cc';
$DB_user = 'trendtec_mtknetwork';
$DB_pass = 'F1005r90@';
$DB_name = 'trendtec_mtknetwork';
...
$location = '/home/mediatek/script.mediatek-vpn.com/ssh/priv/activeprivate.txt';
$fp = fopen($location, 'w');
...
WHERE ".$freeze." AND ".$private_deactived." OR ".$is_activate." OR ".$status."
");
...
$location2 = '/home/mediatek/script.mediatek-vpn.com/ssh/priv/notactiveprivate.txt';
